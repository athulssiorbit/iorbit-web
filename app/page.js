...
import Testimonials from './Pages/TestimonialSection/Testimonials'
export default function Home() {
  return (
    <>
      ...
      <SecondSection />
      <ThirdSection />
      <FourthSection image="/ipad.webp" btn data={{count:1,title:"Book a meeting",content:"Need help with connectivity as part of your digital transformation? Contact iOrbit today to see how we can help."}}/>
      <FourthSection image="/iphone.webp" rev data={{count:2,title:"Easy-install and go live",content:"When you partner with iOrbit, we take the implementation pain away with a quick integration into your existing IT infrastructure and workflows."}} />
      <FourthSection image="/monitor.webp" data={{count:3,title:"Access, analyze, and deliver",content:"Data is connected within minutes of going live with iOrbit. With accessible data and powerful new insights right at your fingertips, your clinical staff will be ready to confidently increase caseload types and volume, without sacrificing the quality of care."}}/>
      <FifthSection />
      <SixthSection />
      <OurServices />
      <Testimonials />
